    ...
    <div id="cont" class="container">
      <div id="form" class="col-12 order-lg-3 order-sm-2">
        <form action="" method="POST">
          ...
          <p>Стаж</p><br />
          <label>
            <input type="radio" name="radio-kon" value="0" />0-2
          </label>
          <label>
            <input type="radio" name="radio-kon" value="1" />2-5
          </label>
          <label>
            <input type="radio" name="radio-kon" value="2" />5-8
          </label>
          <label>
            <input type="radio" name="radio-kon" value="3" />8-10
          </label>
          <label>
            <input type="radio" checked="checked" name="radio-kon" value="4" />10-12
          </label>
          <label>
            <input type="radio" name="radio-kon" value="5" />12-15
          </label>

          <p>Откуда узнали о нас</p>
          <label>
            <select name="sp-sp[]" multiple=multiple>
              <option value="Immortal">Друзья</option>
              <option value="Through the walls">Реклама</option>
              <option value="Levitation">Случайным образом</option>
            </select>
          </label>
